...
model = Sequential()
model.add(Dense(50, activation='hard_sigmoid', input_dim=784))
...
model2 = Sequential()
model2.add(Dense(250, activation='hard_sigmoid', input_dim=784))
...
model3 = Sequential()
model3.add(Dense(50, activation='hard_sigmoid', input_dim=784,
...
model4 = Sequential()
model4.add(Dense(250, activation='hard_sigmoid', input_dim=784,
                 bias_regularizer=keras.regularizers.l2(0.03)))
...
print("Accuracies")
print("50HLN+no regularization Train/Test: ", train1, test1)
print("50HLN+ regularization Train/Test: ", train3, test3)
print("250HLN+no regularization Train/Test: ", train2, test2)
print("250HLN+ regularization Train/Test: ", train4, test4)
